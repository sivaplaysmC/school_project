...
_G.packer_plugins = {
  ["AutoSave.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = true,
    path = "/root/.local/share/nvim/site/pack/packer/opt/AutoSave.nvim",
  ...
  ["TrueZen.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/root/.local/share/nvim/site/pack/packer/opt/TrueZen.nvim",
  ...
  ["better-escape.vim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/root/.local/share/nvim/site/pack/packer/opt/better-escape.vim",
  ...
  ["cheatsheet.nvim"] = {
    ...
    needs_bufread = true,
    only_cond = false,
    path = "/root/.local/share/nvim/site/pack/packer/opt/cheatsheet.nvim",
  ...
  neoformat = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/root/.local/share/nvim/site/pack/packer/opt/neoformat",
  ...
  ["nvim-base16.lua"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/root/.local/share/nvim/site/pack/packer/opt/nvim-base16.lua",
  ...
  ["nvim-compe"] = {
    ...
    after_files = { "/root/.local/share/nvim/site/pack/packer/opt/nvim-compe/after/plugin/compe.vim" },
  ...
  ["plenary.nvim"] = {
    after = { "telescope.nvim", "gitsigns.nvim", "popup.nvim" },
    load_after = {
  ...
  ["telescope-media-files.nvim"] = {
    loaded = true,
    needs_bufread = false,
    path = "/root/.local/share/nvim/site/pack/packer/opt/telescope-media-files.nvim",
